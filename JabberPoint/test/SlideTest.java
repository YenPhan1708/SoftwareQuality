...
public class SlideTest {
    ...
    public void testAppendTextItem() {
        slide.appendTextItem(1, "Test message");
    ...
    public void testGetSlideItemsReturnsVector() {
        slide.appendTextItem(1, "One");
        slide.appendTextItem(2, "Two");
    ...
    public void testAppendNullSlideItem() {
        assertDoesNotThrow(() -> slide.appendSlideItem(null));
        assertEquals(1, slide.getSize());
        assertNull(slide.getSlideItem(0));
    }

    @Test
    public void testAppendTextItemWithNullText() {
        assertDoesNotThrow(() -> slide.appendTextItem(1, null));
        SlideItem item = slide.getSlideItem(0);
        assertTrue(item instanceof TextItem);
    ...
    @Test
    public void testAppendTextItemWithNegativeLevel() {
        slide.appendTextItem(-1, "Negative level test");
        SlideItem item = slide.getSlideItem(0);
        assertEquals(-1, item.getLevel());
    }
    ...
    public void testDrawWithNullObserverDoesNotThrow() {
        ...
        slide.appendTextItem(1, "Some content");
